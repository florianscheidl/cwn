...
def get_parser():
    ...
    parser.add_argument('--validation_technique', type=str, default='random_splits',
    ...
    # Miscellaneous which we will not use here (only defaults).
    ...
    parser.add_argument('--jump_mode', type=str, default=None,
                        help='Mode for JK (default: None, i.e. no JK)') # WILL NOT USE
    return parser
